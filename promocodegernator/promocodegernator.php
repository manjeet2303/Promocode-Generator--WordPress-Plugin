<?php 
    ...
    Description: Plugin For Generating Referral Codes
...

{
  ...
  add_menu_page( 'Referral Code Generator', 'Referral Code Generator', 'manage_options', 'main_page', 'promo_code_generator_home', '', 6 ); 

  

  add_submenu_page('main_page', 'Add  Referral Agents', 'Add  Referral Agents', 'manage_options', 'doctors_page', 'add_doctors' );

  

  add_submenu_page('main_page', 'Assign Referral Code', 'Assign Referral Code', 'manage_options', 'promo_page', 'add_promo_code' );

  

  add_submenu_page('main_page', 'Referral Agent Commission', 'Referral Agent Commission', 'manage_options', 'commission_page', 'doctor_comission' );
  ...
  add_submenu_page( 
	...
	add_submenu_page( 
        ...
        , 'Edit Referral Code'    // -> Page Title

        , 'Edit Referral Code'    // -> Title that would otherwise appear in the menu
	...
	add_submenu_page( 
        ...
        , 'Assign Referral Code'    // -> Page Title

        , 'Assign Referral Code'    // -> Title that would otherwise appear in the menu
	...
	add_submenu_page( 
        ...
        , 'Edit Assigned Referral Code'    // -> Page Title

        , 'Edit Assigned Referral Code'    // -> Title that would otherwise appear in the menu
	...
	add_submenu_page( 
        ...
        , 'Check Referral Agent Commission'    // -> Page Title

        , 'Check Referral Agent Commission'    // -> Title that would otherwise appear in the menu
    ...
    add_submenu_page( 
        ...
        , 'Edit Referral Agent Detail'    /* -> Page Title*/

        , 'Edit Referral Agent Detail'    /* -> Title that would otherwise appear in the menu*/
...
?>
    ...
    <h1>
	  ...
	  Add Referral Agent<span>Please fill all the fields.</span>
    ...
    <label>
        ...
        <span>Referral Agent Name :</span>

        <input id="name" type="text" name="name" placeholder="Enter Referral Agent name" />
    ...
    <label>
        ...
        <span>Referral Agent Email :</span>
    ...
    <!--label>
        ...
        <span>Message To Referral Agent :</span>

        <textarea id="message" name="message" placeholder="Your message to Referral Agent"></textarea>
	...
	<label>
        ...
        <input type="submit" class="button" value="Add Referral Agent" />
...
<form action="" method="post" id="edit_doctor_detail" class="elegant-aero" onsubmit="return(submit_data());">
    ...
    <h1>
	  ...
	  Edit Referral Agent Detail<span>Please fill all the fields.</span>
    ...
    <label>
        ...
        <input id="name" type="text" name="name" placeholder="Enter Referral Agent name" value="<?php echo $row['name'];?>"/>
...
<form action="" method="post" id="generate_promo_code_form" class="elegant-aero" onsubmit="return(generate_promo_code_detail());">
	...
	<!--tr>
	  ...
	  <td colspan="1">Referral Agent:</td>
...
{	
...

	{
		...
		$res = 'Referral Code '.$promo_code.' Expired';
...
<th>Referral Code</th><th>Promo Commission</th>
...

	{
	   ...
	   $data['promo_commision'] = $promo_commision;
        ...
        {	
            ...
            $res = email_to_doctor('pittmanpillow@gmail.com',$data);	
...

	{
		...
		$sql = 'UPDATE wp_promo_doctors SET code_name="'.$_POST['promo_code'].'", status="'.$_POST['promo_status'].'" WHERE doctor_email="'.$_POST['doctor_email'].'"';
...

			{
				...
				echo 'Referral Code Assigned Successfully';
...
?>	
    ...
    <h1>
	  ...
	  Edit Assigned Referral Code To Referral Agent
...

	{
...

		{
...

			{
				...
				echo 'Referral Code Updated Sucessfully';
...

{
    ...
    <h1>
	  ...
	  Generate Referral Codes For Referral Agents<span>Please fill all the fields.</span>
...
<a href="admin.php?page=add_new_code_menu_handle" class="likeabutton">Add New Referral Code</a>
...
?>
  ...
  <form action="" method="post" id="add_promo_code_form" class="elegant-aero" onsubmit="return(submit_promo_code_detail());">
    ...
    <h1>
	  ...
	  Assign Referral Codes To Referral Agents<span>Please fill all the fields.</span>
    ...
    <label>
        ...
        <span>Select Referral Agent Email :</span>

        <!--input id="email" type="email" name="email" placeholder="Enter valid email Address" /-->

		<select name="doctors_emails" id="doctors_emails">

		<option value="-1">--Select Referral Agent Email--</option>
	...
	<label>
        ...
        <span>Select Referral Code :</span>
		...
		<option value="-1">--Select Referral Code--</option>
		...
		<h3><span>All Referral Codes Assigned, Please Generate New One to Assign</span></h3>
...
<a href="admin.php?page=assign_promo_code_menu_handle" class="likeabutton">Assign Referral Code To Referral Agents</a>
...
<a href="admin.php?page=add_new_doctor_menu_handle" class="likeabutton">Add New Referral Agent</a>
